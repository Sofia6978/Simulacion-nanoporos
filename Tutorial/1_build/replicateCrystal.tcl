...
# Estos vectores generan la simetría de traslación

# Return a list with atom positions.
proc extractPdbCoords {pdbFile} {
	set r {}
	
	# Get the coordinates from the pdb file. Genera lista de vectores 3D
...
# Extract all atom records from a pdb file. Crea una lista de los átomos iniciales
...
# Shift a list of vectors by a lattice vector. El cristal es replicado
